...
public class SessionSummaryFrame extends JFrame {
    ...
    public SessionSummaryFrame(final CategoryManager categoryManager, SessionManager sessionManager) {
        ...
        categoryManager.addListener(new CategoryManager.Listener() {
            ...
            public void categoriesUpdated(Category[] categories, Category currentCategory) {
                setTitle(
                    String.format(
                        translate("session_summary.session_sumary_category"),
    ...
    private void createComponents() {
        ...
        // labelSessionSummary
        add(new JLabel(translate("session_summary.summary")), "wrap");
        ...
        this.buttonCopyToClipboard = new JButton(translate("session_summary.copy_to_clipboard"));
        add(this.buttonCopyToClipboard, "width 150, right, wrap");

        // buttonOk
        this.buttonOk = new JButton(translate("session_summary.ok"));
    ...
    private void updateSummary(Category currentCategory, Solution[] solutions) {
        ...
        if (solutions.length >= 1) {
            ...
            // statistics
            String[] labels = {
                translate("session_summary.mean"),
                translate("session_summary.average"),
                translate("session_summary.best_time"),
                translate("session_summary.median"),
                translate("session_summary.worst_time"),
                translate("session_summary.standard_deviation"),
            };
        ...
        // best average of X
        String[] labels = {
            translate("session_summary.best_average_of_5"),
            translate("session_summary.best_average_of_12"),
        };
